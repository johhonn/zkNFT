...
export interface StakingTokenInterface extends utils.Interface {
  ...
  functions: {
    ...
    "simpleMint(address)": FunctionFragment;
    ...
    "totalTokensMinted()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "simpleMint", values: [string]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "simpleMint", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "supportsInterface",
    data: BytesLike
  ): Result;
...
export interface StakingToken extends BaseContract {
  ...
  functions: {
    ...
    totalTokensMinted(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    simpleMint(to: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    totalTokensMinted(overrides?: CallOverrides): Promise<PopulatedTransaction>;
